# Prashant's 3D Portfolio Website
...
https://3d-portfoliooo.vercel.app/
...
This portfolio has been personalized for **Prashant**. Key sections updated include:

- **Career & Experience**: Updated with TEDx Organizer and Google Ambassador roles.
- **My Work**: Updated with "Campus Lost & Found", "Sehat Saathi", "Library Management", and "ATM Simulation" projects.
- **Tech Stack**: Updated with Python, Java, C, Gemini, ROS, Cloud platforms, and more.
- **Styling**: Modern Neo-Noir dashboard aesthetic with glassmorphism and transparent backgrounds.

To further adapt this portfolio:
...
- **Styling**: Modify component styles in `src/components/styles/` and global styles in `src/index.css`.
